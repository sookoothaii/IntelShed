import { GeoJsonPrimitive, BufferPoint, BufferPointMaterial, Color, type Viewer } from 'cesium';
...
export type PointStyler = (props: Record<string, unknown>, index: number) => PointStyle;
...
export function removeGeoJsonPrimitive(viewer: Viewer | null, prim: GeoJsonPrimitive | null): void {
