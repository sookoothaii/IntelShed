...
export const OSINT_TOOLS_EXTENDED = [
  ...
  {
    id: 'wb-gibs',
    label: 'WorldBase NASA GIBS Overlays',
    category: 'native',
  ...
  // --- air extended ---
  {
    ...
    category: 'air',
    description: 'Research ADS-B portal — same family as optional WorldBase OpenSky OAuth feed.',
  ...
  // --- sea extended ---
  {
    ...
    stackNote: 'Deep-link MMSI from WorldBase maritime layer.',
    stackRelation: 'complement',
  ...
  },
  {
    ...
    stackNote: 'Alternative to Copernicus Browser + WorldBase STAC.',
    stackRelation: 'complement',
  ...
  },
  {
    ...
    label: 'OpenStreetMap',
    category: 'imagery',
    description: 'Base map used by WorldBase MapLibre pane and many overlays.',
  ...
  },
  {
    ...
    label: 'QGIS',
    category: 'imagery',
    description: 'Open-source desktop GIS — import WorldBase STAC exports and shapefiles.',
  ...
  // --- infra extended ---
  {
    ...
    category: 'infra',
    description: 'Georgia Tech internet outage maps — same source family as WorldBase OUTAGES.',
  ...
  // --- cyber (new category) ---
  {
    ...
    stackNote: 'WorldBase /api/osint/domain now includes cert_names when crt.sh responds.',
    stackRelation: 'complement',
  ...
  },
  {
    ...
    stackNote: 'Link-out from IP/domain context; no API key in WorldBase by default.',
    stackRelation: 'link-only',
  ...
  },
  {
    ...
    stackNote: 'Complements WhatsMyName; not proxied through WorldBase API.',
    stackRelation: 'reference',
  ...
  },
  {
    ...
    stackNote: 'Starting point for tools not yet in WorldBase REFERENCE.',
    stackRelation: 'reference',
