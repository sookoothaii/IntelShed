...
export default function Sparkline({
  ...
  if (series.length < 2) {
    return (
      <svg width={width} height={height} className="spark">
        <line x1={0} y1={height / 2} x2={width} y2={height / 2} stroke="rgba(111,140,132,0.4)" strokeWidth={1} strokeDasharray="2 3" />
      </svg>
    )
  }
  ...
  return (
    <svg width={width} height={height} className="spark" preserveAspectRatio="none">
      ...
      {baseline && (
        <line x1={0} y1={baseY} x2={width} y2={baseY} stroke="rgba(111,140,132,0.35)" strokeWidth={1} strokeDasharray="2 3" />
      )}
