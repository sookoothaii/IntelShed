  ...
  return (
    <div className="entity-panel-skeleton">
      {Array.from({ length: rows }).map((_, i) => (
        <div
          key={i}
          className="entity-panel-skeleton-row"
  ...
  const displayNodes: GraphNode[] =
    graphNodes.length > 0
      ...
      : [
          ...
          ...(entity.neighbours || []).slice(0, 8).map((n) => ({
            id: n.id,
            schema: n.schema,
            caption: n.caption,
            lat: n.lat,
    ...
    <div className="entity-detail-panel">
      ...
      <div className="entity-panel-header">
        ...
        <div className="entity-panel-meta">
          {entity.schema && <span className="entity-panel-schema-badge">{entity.schema}</span>}
        ...
        <div className="entity-panel-id" title={entity.id}>
          {entity.id}
        </div>
      </div>
          ...
          <div className="entity-panel-props">
            {propEntries.slice(0, 20).map((p, i) => (
              <div key={i} className="entity-panel-prop-row">
                ...
                <span className="entity-panel-prop-val" title={p.value}>
                  {p.value}
                </span>
              </div>
            ))}
        ...
        {entity.datasets && entity.datasets.length > 0 && (
          <div className="entity-panel-datasets">
            {entity.datasets.map((d) => (
              <span key={d} className="entity-panel-dataset-tag">
                {d}
              </span>
            ))}
          </div>
