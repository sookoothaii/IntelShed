...
class TestFusionOperatorRank(unittest.TestCase):
    def test_rank_cells_for_operator_prefers_thailand_over_us(self):
        cells = [
            {"lat": 33.0, "lon": -89.0, "score": 0.9, "intensity": 9.0, "sources": ["quakes"]},
            {"lat": 13.75, "lon": 100.5, "score": 0.55, "intensity": 5.0, "sources": ["gdacs"]},
            {"lat": 3.5, "lon": 104.0, "score": 0.7, "intensity": 7.0, "sources": ["gdacs"]},
        ]
