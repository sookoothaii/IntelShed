...
async def _prepare_chat_messages(
    ...
    if ctx or entity_context or search_results or rag_block:
        ...
        system_prompt_base = (
            ...
            "- DuckDuckGo verification: the verify_claim tool searches DuckDuckGo "
            "for fact-checking even without a WEB SEARCH RESULTS block. Use it when "
            "asked to verify or cross-check a claim.\n"
            ...
            "spatial_query for 'within X km of Y' questions, verify_claim for "
